  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @trademarkSearch="trademarkSearch" @attrSearch="attrSearch"/>
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isComplex}" @click="changeOrderType('1')">
                  <a>综合<span v-if="isComplex && isAsc">⬆</span><span v-else-if="isComplex && isDesc">⬇</span></a>
                </li>
                <li :class="{active:isPrice}" @click="changeOrderType('2')">
                  <a>价格<span v-if="isPrice && isAsc">⬆</span><span v-else-if="isPrice && isDesc">⬇</span></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continuous="5" @getPageNo="getPageNo"/>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    changeOrderType(orderType) {
       ...
       let suffix = order[1]
       if (orderType == type) {
          this.searchParams.order = `${orderType}:${suffix == 'asc' ? 'desc':'asc'}`
       } else {
