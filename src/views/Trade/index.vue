  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="userAddress in userAddressList" :key="userAddress.id">
        ...
        <p @click="changeAddress(userAddress)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(detail,index) in orderInfo.detailArrayList" :key="index">
          <li>
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch('getTradeGoodsList')
  },
  computed: {
    ...mapState({
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let result = await this.$API.reqSubmitTrade(this.orderInfo.tradeNo, params)
      if (result.code == 200) {
